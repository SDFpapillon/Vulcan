...
public enum ModArmorMaterials implements ArmorMaterial {
    ...
    VULCAN("vulcan", 50, new int[] {5, 12, 9, 5}, 12,
            SoundEvents.ITEM_ARMOR_EQUIP_NETHERITE, 6.0f, 1.0f, () -> Ingredient.ofItems(ModItems.VULCAN_INGOT));
    ...
    public String getName() {
        return Vulcan.MOD_ID + ":" + this.name;
    }
